...
public class PlanningFitnessFunctionTest extends MockedConfigurationTest {
	...
	public void setUp() throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
		Field field = PlanningFitnessFunction.class.getDeclaredField("LOAD_FACTOR");
		field.setAccessible(true);
		field.set(null, new Integer(1));
	}
	...
	public void testCalculateCostWith2MachineTypesAndNoOnDemandResources(){
		...
		currentPowerPerMachineType.put(MachineType.M1_LARGE, 30 );//15 machines with 2 cores
		currentPowerPerMachineType.put(MachineType.C1_MEDIUM, 16 );//8 machines with 2 cores
		
		double expectedCost = 100 * 15 + 99 * 8 + 216 + 3240;//One year fee for large + one year fee for medium + large usage + medium usage
		assertEquals(expectedCost, function.calcCost(requestsFinishedPerMachineType, meanServiceTimeInMillis, 
				currentPowerPerMachineType, 0, 0, 0), 0.00001);
		
		PowerMock.verifyAll();
	}
	
	@Test
	public void testCalculateCostWith2MachineTypesAndOnDemandResources() throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
		List<TypeProvider> types = new ArrayList<TypeProvider>();
		types.add(new TypeProvider(0, MachineType.M1_LARGE, 0.1, 0.01, 100, 170, 5));
		types.add(new TypeProvider(0, MachineType.C1_MEDIUM, 0.6, 0.25, 99, 188, 5));
		...
		//Simulating that hours have been evaluated!
		Field field = PlanningFitnessFunction.class.getDeclaredField("totalOnDemandConsumedHrs");
		field.setAccessible(true);
		field.set(function, 3d);
		
		double expectedCost = 100 * 15 + 99 * 8 + 108 + 1620 + 0.6;//One year fee for large + one year fee for medium + large usage + medium usage + on-demand cost
	 ...
	 */
	@Test
	public void testCalculateCostWith2MachineTypesAndOnDemandResources2() throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
		List<TypeProvider> types = new ArrayList<TypeProvider>();
		types.add(new TypeProvider(0, MachineType.M1_LARGE, 0.1, 0.01, 100, 170, 5));
		types.add(new TypeProvider(0, MachineType.C1_MEDIUM, 0.6, 0.25, 99, 188, 5));
		types.add(new TypeProvider(0, MachineType.M1_SMALL, 0.2, 0.1, 50, 70, 5));
		...
		//Simulating that on-demand hours have been consumed
		Field field = PlanningFitnessFunction.class.getDeclaredField("totalOnDemandConsumedHrs");
		field.setAccessible(true);
		field.set(function, 17280/0.2);

		double expectedCost = 100 * 15 + 99 * 8 + 108 + 1620 + 17280;//One year fee for large + one year fee for medium + large usage + medium usage + on-demand cost
		
		assertEquals(expectedCost, function.calcCost(finishedRequestsPerMachineType, meanServiceTimeInMillis, currentPowerPerMachineType, 
				0, 622080900, 0), 0.00001);
	...
	public void testCalculateCostWithOnlyOneThroughput(){
		...
		double expectedCost = 100 * 15 + 99 *8 + 71.99993;//One year fee for large + one year fee for medium + large usage + medium usage
		assertEquals(expectedCost, function.calcCost(finishedRequestsPerMachineType, meanServiceTimeInMillis, currentPowerPerMachineType, 
				0, 0, 0), 0.001);
	...
	@Test
	public void testCalculateCostWithOnlyOneThroughputAndOnDemandResources() throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
		List<TypeProvider> types = new ArrayList<TypeProvider>();
		types.add(new TypeProvider(0, MachineType.M1_LARGE, 0.1, 0.01, 100, 170, 5));
		types.add(new TypeProvider(0, MachineType.C1_MEDIUM, 0.6, 0.25, 99, 188, 5));
		...
		Field field = PlanningFitnessFunction.class.getDeclaredField("totalOnDemandConsumedHrs");
		field.setAccessible(true);
		field.set(function, 2160/0.1);
		
		double expectedCost = 100 * 15 + 99 *8 + 71.99993 + 2160;//One year fee for large + one year fee for medium + large usage + on-demand usage
		assertEquals(expectedCost, function.calcCost(finishedRequestsPerMachineType, meanServiceTimeInMillis, currentPowerPerMachineType, 
				0, 5 * 31104000, 0), 0.001);
		
		PowerMock.verifyAll();
	}
	
	@Test
	public void testCalculateCostWithoutFinishRate(){
		List<TypeProvider> types = new ArrayList<TypeProvider>();
		types.add(new TypeProvider(0, MachineType.M1_LARGE, 0.1, 0.01, 100, 170, 5));
		types.add(new TypeProvider(0, MachineType.C1_MEDIUM, 0.6, 0.25, 99, 188, 5));
		types.add(new TypeProvider(0, MachineType.M1_SMALL, 0.1, 0.05, 50, 70, 5));
	...
	@Test
	public void testCalculateCostWithoutCpuDemand(){
		List<TypeProvider> types = new ArrayList<TypeProvider>();
		types.add(new TypeProvider(0, MachineType.M1_LARGE, 0.1, 0.01, 100, 170, 5));
		types.add(new TypeProvider(0, MachineType.C1_MEDIUM, 0.6, 0.25, 99, 188, 5));
		types.add(new TypeProvider(0, MachineType.M1_SMALL, 0.1, 0.05, 50, 70, 5));
		...
		double expectedCost = 100 * 15 + 99 *8;//One year fee for large + one year fee for medium + large usage + medium usage
		assertEquals(expectedCost, function.calcCost(finishedRequestsPerMachineType, meanServiceTimeInMillis, currentPowerPerMachineType, 
				0, 0, 0), 0.001);
	...
	@Test
	public void testCalculateCostWithoutCpuDemandAndOnDemandResources(){
		List<TypeProvider> types = new ArrayList<TypeProvider>();
		types.add(new TypeProvider(0, MachineType.M1_LARGE, 0.1, 0.01, 100, 170, 5));
		types.add(new TypeProvider(0, MachineType.C1_MEDIUM, 0.6, 0.25, 99, 188, 5));
		types.add(new TypeProvider(0, MachineType.M1_SMALL, 0.1, 0.05, 50, 70, 5));
...
//		EasyMock.expect(config.getParserPageSize()).andReturn(TickSize.MINUTE);
	...
	public void testEvaluateWithPositiveFitness(){
		...
		double cost = 100 * 15 + 4203.6 * 0.01 + 99 * 5 + 1401.2 * 0.25;//for each machine type: reservation fee + usage
	...
	public void testEvaluateWithPositiveFitnessAndThreeMonths(){
		...
		double cost = 100 * 15 + (4068) * 0.25 + 99 * 5 + (12204) * 0.01;//for each machine type: reservation fee + usage
		double penalties = 0;//Since loss is more than 5%, SaaS client does not pay the provider
	...
	public void testEvaluateWithoutReservingMachines(){
		...
		double receipt = 555 + 10000 + 630 * 0.1 + 99.765 + 10000 + 320 * 0.1;//for each contract: price + setup + extra cpu
		double cost = (14880) * 0.01;//for each machine type: reservation fee + usage
		double penalties = 0;//Since loss is more than 5%, SaaS client does not pay the provider
...
//		EasyMock.expect(config.getParserPageSize()).andReturn(TickSize.MINUTE);
		...
		double cost = largeReservation * 15 + 4203.6 * 0.12 + mediumReservation * 5 + 1401.2 * 0.06; //+ 8183.997777777778 * 0.085;//for each machine type: reservation fee + usage
		double penalties = 0;//Since loss is more than 5%, SaaS client does not pay the provider
