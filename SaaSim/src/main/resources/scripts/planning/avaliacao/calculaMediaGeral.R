...
paste("Lucro geral UT: ", mean(total_ut), "[ ", 1.96*sd(total_ut)/sqrt(length(total_ut))+mean(total_ut), " : ", mean(total_ut) - 1.96*sd(total_ut)/sqrt(length(total_ut)), " ] ")
...
paste("Lucro geral RF: ", mean(total_op), "[ ", 1.96*sd(total_op)/sqrt(length(total_op))+mean(total_op), " : ", mean(total_op) - 1.96*sd(total_op)/sqrt(length(total_op)), " ] ")
...
paste("Ganho geral UT: ", mean(total_gut), "[ ", 1.96*sd(total_gut)/sqrt(length(total_gut))+mean(total_gut), " : ", mean(total_gut) - 1.96*sd(total_gut)/sqrt(length(total_gut)), " ] ")
...
paste("Ganho geral RF: ", mean(total_gop), "[ ", 1.96*sd(total_gop)/sqrt(length(total_gop))+mean(total_gop), " : ", mean(total_gop) - 1.96*sd(total_gop)/sqrt(length(total_gop)), " ] ")
