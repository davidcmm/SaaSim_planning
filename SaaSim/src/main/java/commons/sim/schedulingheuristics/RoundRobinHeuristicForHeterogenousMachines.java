...
/**
 * Simple {@link SchedulingHeuristic} to choose servers in a Round Robin fashion. This heuristic
 * considers that each server has a different number of cores and redistributes requests to servers
 * proportionally to the amount of cores at each server.
 * 
