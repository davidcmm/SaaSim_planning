...
/**
 * Class that is responsible to simulate the execution of an application workload 
 * 
...
public class SimpleSimulator extends JEAbstractEventHandler implements Simulator{
	 ...
	 * @param tiers LoadBalancers of the IT infrastructure
	 */
	...
	/**
	 * Scheduling some bootstrap events
	 */
