...
public class MachineDescriptor implements Serializable{
	 ...
	 * @param providerID Provider ID at which machine was purchased
	 */
	...
	/**
	 * Since a request is processed in the machine an amount of data in transferred from SaaS client to the machine (inTransferenceInBytes)
	 * and a response page is transferred from machine to SaaS client (outTransferenceInBytes)
