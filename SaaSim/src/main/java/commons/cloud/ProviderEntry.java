...
/**
 * This class represents an entry that contains costs information for an IaaS provider. 
 * Such information is related to a past evaluation period at which resources were already
 * consumed.
 * 
...
public class ProviderEntry implements Serializable{
	...
	/**
	 * This method accounts for resources consumption.
	 * @param typeEntry Consumption information for a certain resource type
	 */
