...
/**
 * This class is used for data analysis. It reads reservation plans created during simulation
 * in order to create a single line containing the amount of resources reserved per each type
