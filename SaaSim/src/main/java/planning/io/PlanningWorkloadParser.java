...
/**
 * This class reads workload statistics to be used by {@link OptimalHeuristic}.
...
public class PlanningWorkloadParser extends PropertiesConfiguration{
	...
	/**
	 * Checking if all statistics were defined.
	 * @throws ConfigurationException
	 */
	...
	/**
	 * Creating a summary object to represent statistics
	 * @param monthArrivalRate
	 * @param monthCpuDemandInHours
	 * @param monthRequestServiceDemand
	 * @param monthUserThinkTime
	 * @param monthNumberOfUsers
	 * @return
	 */
